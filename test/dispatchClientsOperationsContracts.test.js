...
test('dispatch clients operations contracts', () => {
  ...
  assert.match(schema, /publicToken/);
  ...
  ['worker-list', 'max-height', 'overflow-y:auto', 'request-list', 'Clientes', 'Solicitudes de servicio', 'Crear solicitud interna'].forEach((s) => assert.match(view, new RegExp(s)));
