...
test('la plantilla Meta usa cuatro variables y un único Quick Reply sin CTA URL', () => {
...
test('la vista deriva al coordinador y muestra el contrato de cuatro variables y Quick Reply', () => {
