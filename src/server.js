  ...
  res.render = (view, locals = {}, callback) => {
    originalRender(view, locals, (error, html) => {
      ...
      const output = shouldInject
        ? html.replace('</body>', '<script src="/public/assignment-confirm-dialog.js"></script><script src="/public/assignment-template-sync.js"></script><script src="/public/assignment-active-requests.js"></script></body>')
        : html;
