...
const VACANCY_INFORMATION_TOPICS = /\b(vacante|oferta|convocatoria|cargo|trabajo|opcion|alternativa|funcion|funciones|labor|labores|requisito|requisitos|salario|sueldo|pago|horario|turno|ubicacion|direccion|zona|condiciones|contrato|beneficio|beneficios|documentos|experiencia|edad|empresa|compania|cliente|operacion)\b/;
